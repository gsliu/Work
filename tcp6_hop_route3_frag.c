...
main (int argc, char **argv)
{
 ...
 // int hoplen, mtu, *frag_flags, *tcp_flags, c, nframes, offset[MAX_FRAGS], len[MAX_FRAGS], route_datlen;
  int  mtu, *frag_flags, *tcp_flags, c,  offset[MAX_FRAGS], len[MAX_FRAGS], route_datlen;
//  hop_hdr hophdr;
  route_hdr routehdr;
        ...
        dst_mac[3] = 0x0a;
          ...
          dst_mac[5] = 0xf8;
            ...
            // Source IPv6 address: you need to fill this out
                   strcpy (src_ip, "2620:52:0:42c0:5054:ff:fefe:4ae5");
                     strcpy (target, "2620:52:0:42c0:5eff:35ff:fe0a:29f8");
...
*/
  ...
  */
  ...
  strcpy (address, "2620:52:0:42c0:5eff:35ff:fe0a:29f8");
  ...
  routehdr.routing_type = 2;  // Source Routing Header for RPL
  routehdr.segs_left = 1;  // Number of segments left: 3 (number of addresses)
...
//  fclose (fi);
  ...
  */
  ...
  while (c < fragbufferlen) {
    ...
    if ((fragbufferlen - c) > (mtu - IP6_HDRLEN -  RTE_HDRLEN - route_datlen - FRG_HDRLEN)) {  // Yes
      len[i] = mtu - IP6_HDRLEN  - RTE_HDRLEN - route_datlen - FRG_HDRLEN;  // len[i] is amount of fragmentable part we can include in this frame.
